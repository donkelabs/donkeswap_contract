...
To build a price oracle on Donke V2, you must first understand the
...
[here](../../../../contracts/periphery/examples/ExampleOracleSimple.sol).
...
that you can compute using the Donke cumulative price variable.
...
[here](../../../../contracts/periphery/examples/ExampleSlidingWindowOracle.sol).
...
[`DonkeV2OracleLibrary#currentCumulativePrices`](../../../../contracts/periphery/libraries/DonkeV2OracleLibrary.sol#L16)
...
The `DonkeV2Pair` cumulative price variables are designed to eventually overflow,
...
[ExampleSlidingWindowOracle](../../../../contracts/periphery/examples/ExampleSlidingWindowOracle.sol)
